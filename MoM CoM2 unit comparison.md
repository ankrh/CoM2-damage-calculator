...
|--------------------------------|------------|------------|------------|------------|------------|-------|------------------|------------------|-----------|
| Dwarf (Brax)                   |          1 |      4 → 9 |      4 → 5 |     9 → 10 |     9 → 15 |     - | -                | -                |  |
| Barbarian (Gunther)            |          1 |      4 → 8 |      3 → 4 |          5 |     8 → 14 |     - | -                | 2 (Thrown) → 5 (Thrown) |  → Cold Imm |
| Sage (Zaldron)                 |          1 |      - → 1 |          4 |      5 → 6 |     4 → 10 |     - | 5 (Magic(S)) → 10 (Magic(S)) | -                |  |
| Dervish (B'Shan)               |          1 |      3 → 8 |      4 → 5 |          5 |     5 → 11 |     - | 3 (Missile) → 9 (Missile) | -                |  |
| Beastmaster (Rakir)            |          1 |      4 → 7 |      4 → 5 |      5 → 6 |     6 → 12 |     - | - → 9 (Missile)  | -                |  → Negate FS |
| Bard (Valana)                  |          1 |      3 → 8 |          5 |      5 → 6 |     5 → 11 |     - | -                | -                |  → Holy Bonus 1 |
| Orc Warrior (Bahgtru) → Orc Archer (Bahgtru) |          1 |      5 → 7 |      4 → 6 |      5 → 7 |     7 → 12 |     - | - → 10 (Missile) | 2 (Thrown) → -   |  |
| Healer (Serena)                |          1 |      2 → 3 |      5 → 6 |      6 → 8 |     4 → 10 |     - | 5 (Magic(N)) → 10 (Magic(N)) | -                |  |
| Huntress (Shuri)               |          1 |          4 |      3 → 5 |          5 |     6 → 12 | - → +5% | 3 (Missile) → 12 (Missile) | -                |  |
| Druid (Greyfairer)             |          1 |      - → 1 |          5 |          5 |     4 → 10 |     - | 7 (Magic(N)) → 10 (Magic(N)) | -                |  |
| Warrior Mage (Reywind)         |          1 |      3 → 8 |      4 → 6 |          5 |     6 → 12 |     - | 3 (Magic(C)) → 8 (Magic(C)) | -                |  |
| Chosen (Torin)                 |          1 |    11 → 12 |          8 |    11 → 12 |    11 → 13 |     - | -                | -                | Missile Imm, Magic Imm → Negate FS, Holy Bonus 1 |
| Rogue (Spyder)                 |          1 |     6 → 11 |      5 → 6 |          5 |     7 → 13 |     - | -                | -                |  |
| War Monk (Taki)                |          1 |     5 → 10 |      5 → 6 |          5 |     5 → 11 |     - | -                | -                |  → Negate FS |
| Assassin (Tumu)                |          1 |     2 → 10 |          5 |          5 |     5 → 12 |     - | -                | -                | Poison Touch 5 → First Strike, Poison Touch 9, Stealth |
| Ranger (Marcus)                |          1 |      5 → 8 |          5 |      5 → 6 |     7 → 13 |     - | 4 (Missile) → 11 (Missile) | -                |  → Poison Imm |
| Draconian (Fang)               |          1 |     6 → 10 |          5 |      5 → 6 |     7 → 13 |     - | -                | 4 (Fire) → 5 (Fire) | Flying |
| Golden One (Aureus)            |          1 |     5 → 10 |      6 → 7 |      5 → 9 |     5 → 11 |     - | 5 (Magic(C)) → 10 (Magic(C)) | -                |  → Negate FS |
| Thief (Theria)                 |          1 |      4 → 9 |      5 → 4 |          5 |     6 → 12 |     - | -                | -                |  → Stealth |
| Wind Mage (Jaer)               |          1 |      - → 1 |          5 |          5 |     4 → 10 |     - | 5 (Magic(N)) → 10 (Magic(S)) | -                | Missile Imm |
| Witch (Morgana)                |          1 |      - → 1 |          5 |          5 |     4 → 10 |     - | 7 (Magic(C)) → 12 (Magic(C)) | -                | Missile Imm |
| Magician (Malleus)             |          1 |      - → 1 |          5 |      9 → 8 |     4 → 10 |     - | 7 (Magic(C)) → 12 (Magic(C)) | -                | Missile Imm |
| Ninja (Shin Bo)                |          1 |     5 → 10 |      5 → 6 |          5 |     6 → 12 |     - | -                | -                | Invisible |
| Amazon (Shalla)                |          1 |     6 → 10 |      4 → 5 |          5 |     7 → 12 |     - | -                | 3 (Thrown) → 4 (Thrown) |  → Negate FS |
| Warlock (Yramrag)              |          1 |      - → 1 |          5 |      9 → 8 |     4 → 10 |     - | 7 (Magic(C)) → 12 (Magic(C)) | -                | Missile Imm |
| Unknown (Mystic X)             |          1 |      4 → 9 |      4 → 6 |      9 → 8 |     7 → 13 |     - | 4 (Magic(C)) → 9 (Magic(C)) | -                |  |
| Illusionist (Aerie)            |          1 |      - → 1 |      4 → 6 |      5 → 6 |     4 → 10 |     - | 4 (Magic(S)) → 9 (Magic(S)) | -                | Missile Imm, Illusion |
| Swordsman (Deth Stryke)        |          1 |     5 → 10 |      5 → 7 |      5 → 6 |     9 → 15 |     - | -                | -                |  |
| Priestess (Elana)              |          1 |      1 → 2 |      5 → 7 |      5 → 8 |     4 → 10 |     - | 7 (Magic(N)) → 12 (Magic(N)) | -                | Missile Imm → Negate FS |
| Paladin (Roland)               |          1 |     8 → 11 |      5 → 7 |      5 → 6 |     7 → 13 |     - | -                | -                | Armor Piercing, First Strike, Magic Imm → Armor Piercing, First Strike, Negate FS, Illusion Imm |
| Black Knight (Mortu)           |          1 |     8 → 11 |      5 → 7 |      5 → 6 |     9 → 15 |     - | -                | -                | Armor Piercing, First Strike, Magic Imm → Armor Piercing, First Strike, Negate FS, Death Imm |
| Elven Archer (Alorra)          |          1 |      4 → 5 |      6 → 8 |      5 → 8 |     5 → 11 | - → +10% | 7 (Missile) → 12 (Magic(N)) | -                |  |
| Knight (Sir Harold)            |          1 |     7 → 12 |      5 → 7 |      5 → 6 |     8 → 18 |     - | -                | -                |  → Negate FS |
...
| Unit                           |  Fig       | Melee      | Def        | Res        | HP         | ToHit | Ranged           | Thrown/Breath    | Abilities |
|--------------------------------|------------|------------|------------|------------|------------|-------|------------------|------------------|-----------|
| Guardian Spirit                |          1 |     10 → 7 |      4 → 6 |         10 |         10 | - → +30% | -                | -                | Non-Corp, Resist All 1 → Non-Corp, Poison Imm, Resist All 1 |
| Unicorns                       |          4 |      5 → 6 |      3 → 4 |          7 |      6 → 8 |  +20% | -                | -                | Poison Imm, Resist All 2 |
| Angel                          |          1 |    13 → 18 |      7 → 9 |     8 → 11 |    15 → 27 |  +20% | -                | -                | Flying, Illusion Imm, Dispel Evil, Holy Bonus 1 → Flying, Illusion Imm, Holy Bonus 1 |
| Phoenix                        |      - → 1 |     - → 20 |      - → 6 |     - → 10 |     - → 32 | - → +20% | -                | -                | - → Flying, Death Imm, Fire Imm, Regen 3 |
| Archangel → Arch Angel         |          1 |    15 → 21 |    10 → 12 |    12 → 18 |    18 → 37 | +30% → +40% | -                | -                | Flying, Illusion Imm, Holy Bonus 2 → Flying, Negate FS, Illusion Imm, Supernatural, Holy Bonus 2 |

## Summoned — Death

| Unit                           |  Fig       | Melee      | Def        | Res        | HP         | ToHit | Ranged           | Thrown/Breath    | Abilities |
|--------------------------------|------------|------------|------------|------------|------------|-------|------------------|------------------|-----------|
| Skeletons                      |      6 → 7 |          3 |          4 |      4 → 3 |          1 |  +10% | -                | -                | Missile Imm, Illusion Imm, Death Imm, Cold Imm, Poison Imm |
| Zombies                        |          6 |          4 |          3 |          3 |          3 |  +10% | -                | -                | Illusion Imm, Death Imm, Cold Imm, Poison Imm → Illusion Imm, Death Imm, Cold Imm, Block 20% |
...
| Death Knights                  |          4 |     9 → 12 |      8 → 9 |         10 |          8 |  +30% | -                | -                | Flying, Armor Piercing, First Strike, Illusion Imm, Weapon Imm, Death Imm, Cold Imm, Poison Imm, Life Steal 14 → Flying, Non-Corp, Armor Piercing, First Strike, Negate FS, Illusion Imm, Weapon Imm, Death Imm, Cold Imm, Poison Imm, Life Steal -5, Supernatural |
| Demon Lord                     |          1 |    20 → 25 |     10 → 8 |    12 → 13 |    20 → 35 |  +30% | 10 (Magic(C)) → 20 (Magic(C)) | -                | Flying, Illusion Imm, Weapon Imm, Death Imm, Cold Imm, Poison Imm, Fear, Life Steal 15 → Flying, Negate FS, Missile Imm, Illusion Imm, Weapon Imm, Death Imm, Fear, Life Steal -2, Supernatural |

## Summoned — Chaos

| Unit                           |  Fig       | Melee      | Def        | Res        | HP         | ToHit | Ranged           | Thrown/Breath    | Abilities |
|--------------------------------|------------|------------|------------|------------|------------|-------|------------------|------------------|-----------|
| Hell Hounds                    |          4 |      3 → 4 |          2 |      6 → 5 |          4 |  +10% | -                | 3 (Fire) → 4 (Fire) |  |
| Fire Elemental                 |          1 |         12 |      4 → 5 |      6 → 4 |         10 |     - | -                | -                | Fire Imm, Poison Imm, Stone Imm → Weapon Imm, Fire Imm, Poison Imm, Stone Imm |
...
| Great Drake                    |          1 |    30 → 35 |    10 → 11 |    12 → 15 |    30 → 40 |  +30% | -                | 30 (Fire) → 35 (Fire) | Flying → Flying, Negate FS, Supernatural |
...
| Unit                           |  Fig       | Melee      | Def        | Res        | HP         | ToHit | Ranged           | Thrown/Breath    | Abilities |
|--------------------------------|------------|------------|------------|------------|------------|-------|------------------|------------------|-----------|
| Phantom Warriors → Phantom Warrior |      6 → 7 |          3 |          - |      6 → 4 |          1 |     - | -                | -                | Non-Corp, Death Imm, Poison Imm, Stone Imm, Illusion |
| Phantom Beast                  |          1 |         18 |          - |      8 → 6 |    20 → 25 |  +10% | -                | -                | Non-Corp, Death Imm, Poison Imm, Stone Imm, Illusion |
| Nagas                          |      2 → 3 |      4 → 5 |      3 → 4 |          7 |      6 → 5 |  +10% | -                | -                | First Strike, Poison Touch 4 → First Strike, Poison Touch 3 |
| Water Elemental                |      - → 1 |     - → 14 |      - → 7 |      - → 7 |     - → 15 | - → +20% | - → 14 (Magic(S)) | -                | - → Weapon Imm, Fire Imm, Poison Imm |
| Air Elemental                  |          1 |         15 |      8 → 7 |          9 |         10 |  +10% | -                | -                | Flying, Weapon Imm, Poison Imm, Stone Imm, Invisible → Flying, Non-Corp, Armor Piercing, Weapon Imm, Poison Imm, Stone Imm, Invisible |
| Storm Giant                    |          1 |    12 → 18 |          7 |          9 |    20 → 25 |  +20% | 10 (Magic(C)) → 18 (Magic(C)) | -                | Armor Piercing → Armor Piercing, Missile Imm, Wall Crusher |
| Djinn                          |          1 |    15 → 18 |          8 |    10 → 12 |    20 → 29 |  +30% | 8 (Magic(N)) → 15 (Magic(S)) | -                | Flying → Flying, Supernatural |
| Sky Drake                      |          1 |    20 → 28 |         10 |         14 |    25 → 30 |  +30% | -                | 20 (Lightning) → 21 (Lightning) | Flying, Magic Imm, Illusion Imm → Flying, Negate FS, Magic Imm, Illusion Imm, Supernatural |

## Summoned — Arcane

| Unit                           |  Fig       | Melee      | Def        | Res        | HP         | ToHit | Ranged           | Thrown/Breath    | Abilities |
|--------------------------------|------------|------------|------------|------------|------------|-------|------------------|------------------|-----------|
| Magic Spirit                   |          1 |          5 |          4 |          8 |         10 |     - | -                | -                | Non-Corp → Non-Corp, Poison Imm |
